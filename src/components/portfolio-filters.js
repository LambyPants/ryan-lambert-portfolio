...
class Buttons extends Component {
    ...
    renderButtons(){
       return  this.props.filter.map((button, i)=>{
            ...
            <button  className={classNames("btn btn-primary btn-lg", {"activeButton": this.state.activeButton === button})} key={i} value={button}  onClick={(e)=>{this.props.filteredProjects(e.target.value); this.addActiveClass(e.target)}}>{button}</button> 
