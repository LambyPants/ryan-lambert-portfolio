            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="intro-text">
                  ...
                  <h5>
                    {" "}
                    Explore my work and always feel free to reach out with a
                    project idea!{" "}
                  </h5>
                </div>
              </div>
              <div className="row">
                <div className="col-lg-12">
                  <div className="header-links">
                    <a href="https://www.linkedin.com/in/ryan-lambert-58202596">
                      <i className="fa fa-github" aria-hidden="true" />
                    </a>
                    <a href="https://www.linkedin.com/in/ryan-lambert-58202596">
                      <i className="fa fa-linkedin-square" aria-hidden="true" />
                    </a>
                    <a href="mailto:ryanlandonlambert@gmail.com">
        ...
        <footer>
          ...
          <div className="footer-below">
            <div className="container">
              <div className="row">
                <div className="col-lg-12">
                  I made this site using React.js and Redux - check out the code
                  for{" "}
                  <span>
                    <a href="https://github.com/LambyPants/ryan-lambert-portfolio">
                      this site
                    </a>
                  </span>{" "}
                  and all my other projects on my GitHub.
                </div>
              </div>
            </div>
          </div>
